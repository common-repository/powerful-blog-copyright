<?php
/*  Copyright 2008-2009  Sharath (email : blogform.chetan@gmail.com)
    ...
    Foundation, Inc., 59 Temple Place, Suite 330, Boston, MA  02BTE-1307  USA
*/
...
function bte_bc_options() {		
	...
	print('
			<div class="wrap">
				<h2>'.__('Powerfull Blog Copyright by', 'BlogCopyright').' <a href="http://111waystomakemoney.com">Sharath</a></h2>
<h1 style="text-align: left">For Instructions Visit:<a href="http://111waystomakemoney.com/powerful-blog-copyright/" target="_blank">Plugin Page</a></h1>
...
<h2 style="text-align: left">If u like the plugin please Donate:<a href="http://111waystomakemoney.com/donate/" target="_blank">Plugin Donation Page</a></h2>
						<div class="option">
							...
							<ul>
							<li><a href="http://111waystomakemoney.com/wordpress-plugins/powerfull-social-bookmarking-wordpress-plugin/">Powerfull Social Bookmarking</a></li>
							<li><a href="http://111waystomakemoney.com/powerful-blog-copyright//">Powerfull Blog Copyright</a></li>
							<li><a href="http://111waystomakemoney.com/wordpress-plugins/powerfull-blog-post-promoter/">Powerfull Blog Post Promoter</a></li>
